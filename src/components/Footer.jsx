    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold mb-4">🏗️ Konstruksi Indonesia</h3>
            <p className="text-gray-400">
              Solusi konstruksi profesional untuk pembangunan gedung, rumah, dan infrastruktur di seluruh Indonesia.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                href="mailto:info@konstruksi.co.id"
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} Konstruksi Indonesia. Semua hak dilindungi.</p>
        </div>
      </div>
    </footer>
  )
